...
"""
TileSwap logic wrapper for use in manipulation tasks
"""

class TileSwapGameLogic:
    """Logic for TileSwap game, based on the 'TileSwapDiscreteEnv'"""

    # The structure of this class is inspired by the `TicTacToeGameLogic` class in
    # `<PPG>/board_games/tic_tac_toe_logic.py`.

    def __init__(self, tileswap_discrete):
        self._tile_swap_discrete = tileswap_discrete
        self.reset()

    @property
    def board_size(self):
        return self._tile_swap_discrete.board_size

    @property
    def max_solution_depth(self):
        return self._tile_swap_discrete.max_solution_depth

    def seed(self, seed=None):
        self._tile_swap_discrete.seed(seed)

    def reset(self):
        self._tile_swap_discrete.reset()
    ...
    def get_board_state(self):
        ...
        Returns:
          ...
          of the board.
        """
        return self._tile_swap_discrete.board_state.copy()
    ...
    def apply(self, contact_info):
        ...
        Args:
          contact_info: A `TileSwapBoardContact` instance.

        Returns:
          True if the action was valid, else False.
        """
        groundtruth_skill = self._tile_swap_discrete.swap(*contact_info.swap_indices)
        was_valid_move = True
